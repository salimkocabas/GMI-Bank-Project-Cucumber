...
import gmiBank_team22.pages.US_012_EmployeePage;
...
public class US_012_Employee_Steps {
    ...
    US_012_EmployeePage employeePage = new US_012_EmployeePage();
    ...
    public void validate_the_message_of_Showing_Items_and_column_names_in_header() {
        ...
        expectedList = Arrays.asList(new String[]{"First Name", "Last Name", "Middle Initial", "Email", "Mobile Phone Number", "Phone Number", "Address", "Create Date"});
