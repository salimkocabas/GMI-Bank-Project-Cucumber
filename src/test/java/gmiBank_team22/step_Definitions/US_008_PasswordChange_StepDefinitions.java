...
public class US_008_PasswordChange_StepDefinitions {
    ...
    public void type_users_current_password() {
        us_008_passwordChange_page.currentPasword.clear();
        us_008_passwordChange_page.currentPasword.sendKeys(ConfigurationReader.getProperty("customerPassword"));
    ...
    public void repair_current_password(String string) throws InterruptedException {
        us_008_passwordChange_page.currentPasword.clear();
        us_008_passwordChange_page.currentPasword.sendKeys(string);
    }
